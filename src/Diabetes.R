library(tidyverse)
library(boot)
diabetes=read.csv("C:/Users/DELL/Documents/Bhavana_Assignment2/raw_Data/diabetes.csv")
set.seed(123)
...
hist(sample_data$Glucose, main = "Distribution of Glucose in Sample", xlab = "Glucose")
abline(v = mean_glucose, col = "red", lwd = 2)
hist(diabetes$Glucose, main = "Distribution of Glucose in Population", xlab = "Glucose")
abline(v = population_mean_glucose, col = "red", lwd = 2)
